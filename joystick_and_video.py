...
def main():
    ...
    print('num: ',pygame.joystick.get_count())
    js = pygame.joystick.Joystick(0)
    #num = pygame.joystick.Joystick.get_instance_id()
    #print(num)
    ...
    try:
        ...
        elif js_name == 'Wireless Controller':
            buttons = JoystickPS4
        elif js_name in 'Wireless Controller':
            buttons = JoystickPS4
        elif js_name == 'Sony Computer Entertainment':
            buttons = JoystickPS4
        elif js_name in ('Wireless Controller', 'Sony Computer Entertainment'):
            buttons = JoystickPS4
